...
const Cart = () => {
    ...
    const handleDiscard = ()=>{
        setItems([])
        setCart([]);
        navigate('/')  // navigate to home page from here.
    }
    ...
    return (
        <section className="cart-container">
            <section className="cart-cards">
                {items.map((item, index) => {   // mapping over array "items" and passing key  ==> index
                    return (
            ...
            <section className="cart-btns">
                <button className="btn" onClick={handleDiscard}>discard card</button>
